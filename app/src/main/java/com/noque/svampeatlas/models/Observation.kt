...
data class Observation(
    ...
    val date: Date? get() {return Date(_observationDate)}
    ...
    val images: List<Image> get() { return _observationImages.map { Image(0, 0, "https://svampe.databasen.org/uploads/${it.name}.JPG", null)}}
