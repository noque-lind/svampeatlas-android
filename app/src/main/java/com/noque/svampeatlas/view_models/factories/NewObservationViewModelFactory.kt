...
class NewObservationViewModelFactory(val type: AddObservationFragment.Type, val id: Long, val mushroomId: Int, val imageFilePath: String?,  val application: Application):
